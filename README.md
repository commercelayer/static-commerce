...
Create a [free developer account](https://core.commercelayer.io/users/sign_up) on Commerce Layer and &mdash; when prompted &mdash; seed it with test data. Navigate to _Settings_ → _Applications_ and take note of the API credentials for your channel application:

- Client ID
- Base endpoint
- Allowed scopes

<img src="https://raw.githubusercontent.com/commercelayer/static-commerce/master/docs/channel-application.svg" />
